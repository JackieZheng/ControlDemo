...
public class BaseViewHolder extends RecyclerView.ViewHolder {
   ...
   * @return The BaseViewHolder for chaining.
   */
  @Deprecated public BaseViewHolder setOnClickListener(@IdRes int viewId,
   ...
   * @return The BaseViewHolder for chaining.
   */
  @Deprecated public BaseViewHolder setOnTouchListener(@IdRes int viewId,
   ...
   * @return The BaseViewHolder for chaining.
   */
  @Deprecated public BaseViewHolder setOnLongClickListener(@IdRes int viewId,
