...
/**
 * The implementation of the fragment to display grid view. Based on {@link
...
public class ProgressGridFragment extends BaseFragment {
   ...
   * consider including the standard layout {@link  R.layout#fragment_progress_grid}
